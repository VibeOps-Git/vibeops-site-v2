              ...
              <div className="space-y-8 text-muted-foreground">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <p>
                      <strong>"Engagement Document"</strong> means a proposal, statement of work, service agreement, or other ordering document executed by the parties that specifies the scope, fees, deliverables, and term of an engagement, and incorporates this Agreement by reference.
                    </p>
                    <p>
                      <strong>"Services"</strong> means the discovery, implementation, development, deployment, and related software and engineering services VibeOps provides to Customer, including any custom-built tools, integrations, templates, workflow automations, AI Features, and related functionality delivered under an Engagement Document.
                    </p>
                    <p>
                      <strong>"Engagement Term"</strong> means the period during which VibeOps performs the Services and, where applicable, Customer is authorized to access and use software operated by VibeOps, as specified in an Engagement Document.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <p className="mb-4">
                    The Services, and any software VibeOps builds or deploys, are <strong>tools that draft, structure, integrate, and automate engineering work</strong>. They do <strong>not</strong> provide engineering, legal, or professional advice and do <strong>not</strong> replace professional judgment.
                  </p>
                ...
                <div>
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">6.2 Milestones and Acceptance</h3>
                  <p className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">6.3 Ongoing Services</h3>
                  <p className="mb-4">
