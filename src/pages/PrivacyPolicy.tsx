          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="prose max-w-none">
              <div className="space-y-8 text-muted-foreground">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-foreground mb-4">1. Scope and Application</h2>
                ...
                <div>
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">2.1 Information You Provide Directly</h3>
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-3 mt-6">2.2 Information Processed Through the Services</h3>
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-foreground mb-4">5. Access to Customer Data</h2>
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-foreground mb-4">6. Anonymized and Aggregated Data</h2>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-foreground mb-4">7. Disclosure of Information</h2>
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-foreground mb-4">8. Data Storage and Security</h2>
                  <p className="mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-semibold text-foreground mb-4">13. Data Processing Agreements</h2>
                  <p>
                ...
                <div>
                  ...
                  <p className="font-semibold text-foreground">VibeOps Technologies Inc.</p>
                  <p>
                    Email: <a href="mailto:zander@vibeops.ca" className="text-primary hover:text-primary/80 transition-colors">zander@vibeops.ca</a>
                  </p>
                </div>
              </div>
            </div>
