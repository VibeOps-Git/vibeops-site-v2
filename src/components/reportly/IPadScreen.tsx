    ...
    <div className="w-full h-full p-2 sm:p-4 md:p-6 flex flex-col">
      ...
      <div className="flex items-center justify-between mb-2 sm:mb-4 md:mb-6">
        ...
        <div className="px-1.5 sm:px-3 py-0.5 sm:py-1 rounded-full bg-amber-500/20 border border-amber-500/30">
          <span className="text-[8px] sm:text-xs md:text-sm text-amber-400">In Progress</span>
        </div>
      </div>

      {/* Transformation visualization */}
      <div className="flex-1 flex flex-col gap-1.5 sm:gap-3 md:gap-4">
        {/* Source document */}
        <div className="bg-white/5 rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-4 border border-white/10">
          <div className="flex items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-3">
            <FileSpreadsheet className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 text-blue-400" />
            <span className="text-[8px] sm:text-xs md:text-sm text-gray-400">Source Data</span>
          </div>
    ...
    <div className="w-full h-full p-2 sm:p-4 md:p-6 flex flex-col">
      ...
      <div className="flex-1 bg-white rounded-lg sm:rounded-xl overflow-hidden shadow-2xl relative">
        ...
        <div className="bg-gradient-to-r from-slate-800 to-slate-700 p-2 sm:p-3 md:p-4">
          <div className="flex items-center gap-1.5 sm:gap-3">
            ...
            <div>
              ...
              <p className="text-[6px] sm:text-[10px] md:text-xs text-gray-400">Engineering Report</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-2 sm:p-3 md:p-4 space-y-2 sm:space-y-3 md:space-y-4">
          <div>
            <p className="text-[8px] sm:text-xs md:text-sm font-semibold text-gray-800 mb-0.5 sm:mb-1">Site Analysis Report</p>
          ...
          <div className="pt-2 sm:pt-3 md:pt-4 border-t border-gray-200">
            <div className="flex items-center gap-1.5 sm:gap-3">
              ...
              <p className="text-[6px] sm:text-[10px] md:text-xs text-gray-400">Certified Engineer</p>
            </div>
          </div>
        </div>
