...
export function MetricsSection() {
  return (
    <section className="relative py-24 px-4 overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#0a0a0f] via-[var(--emerald-accent)]/5 to-[#0a0a0f]" />
          ...
          {metrics.map((metric, index) => (
            ...
            >
              <div className="relative group">
                {/* Card */}
                <div className="relative p-6 lg:p-8 rounded-2xl bg-[rgba(10,10,20,0.6)] border border-white/5 backdrop-blur-sm transition-all duration-300 group-hover:border-[var(--emerald-accent)]/20 group-hover:bg-[rgba(10,10,20,0.8)]">
                  {/* Icon */}
                  <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-[var(--emerald-accent)]/10 border border-[var(--emerald-accent)]/20 mb-4">
                    <metric.icon className="w-6 h-6 text-[var(--emerald-accent)]" />
                  </div>
